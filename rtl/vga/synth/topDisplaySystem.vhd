...
architecture Structural of TopDisplaySystem is
    ...
    signal Data_inout : STD_LOGIC_VECTOR(31 downto 0); -- Signal interne de liaison
    signal reset_tb : STD_LOGIC := '0'; -- Reset asynchrone

begin

    -- Instanciation du contrôleur IP (lecture données VGA)
    ...
    -- Instanciation du contrôleur d'affichage VGA
